...
jest.mock(
  '../../../infrastructure/utils/dynamodb-cursor-transformer/dynamodb-cursor-transformer',
  () => ({
...
describe('MessageRepository', () => {
  ...
  describe('findBySender', () => {
    ...
    it('should call DynamoDB with correct query parameters', async () => {
      ...
      expect(command.input.ExpressionAttributeValues[':sender']).toBe(
        'testuser',
      );
  ...
  describe('findByDateRange', () => {
    ...
    it('should query with cursor when provided', async () => {
      const {
        decodeCursor,
      } = require('../../../infrastructure/utils/dynamodb-cursor-transformer/dynamodb-cursor-transformer');
  ...
  describe('updateStatus', () => {
    ...
    it('should call DynamoDB with correct update parameters', async () => {
      ...
      expect(
        command.input.ExpressionAttributeValues[':updatedAt'],
      ).toBeLessThanOrEqual(afterUpdate);
      expect(command.input.ConditionExpression).toBe(
    ...
    it('should throw NotFoundException with correct message', async () => {
      ...
      await expect(
        repository.updateStatus('non-existent', 'READ'),
