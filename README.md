...
A documentação do projeto está organizada no diretório [`/docs`](./docs) e descreve as decisões tomadas antes da implementação do código.
...
> **Em desenvolvimento**
> Os comandos e instruções de execução, setup local e detalhes de infraestrutura serão adicionados conforme o projeto evoluir.
